...
(function() {
  var nameToColor, shaven;

  shaven = require('shaven');

  nameToColor = require('../source/nameToColor');

  module.exports = function(config) {
    var defaults, height, icon, shavenArray, width;
    defaults = {
      width: 16,
      height: 16,
    ...
    shavenArray = [
      'svg', {
        ...
        'rect', {
          ...
          height: height,
          style: {
            fill: nameToColor(config.format)
          }
        }
      ], [
        'g', icon[config.type], [
          'text', config.extensions.split(',')[0].slice(-4), {
            x: 8,
            y: 13.5,
            'text-anchor': 'middle',
            style: {
...
},{"../source/nameToColor":7,"shaven":5}],2:[function(require,module,exports){
/*!
 * escape-html
...
},{"escape-html":2}],6:[function(require,module,exports){
'use strict'
...
},{"../build/file-icon":1,"html-tablify":3,"jquery":4}],7:[function(require,module,exports){
'use strict'
...
module.exports = (string) => {
	...
	for (
		...
		sum += string.codePointAt(characterIndex)
	}

	// 8e10 = offset to produce only light colors
	// Padded with leading zeros to produce only valid color hex strings
	return '#' + ('000000' + ((sum + 8e10) % 16777215).toString(16)).slice(-6)
}
